...
#set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { selct[2]  }]; #IO_L9P_T1_DQS_34 Sch=sw[3]
...
#set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { min[1] }]; #IO_0_35 Sch=led[2]
#set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { done }]; #IO_L3N_T0_DQS_AD1N_35 Sch=led[3]
