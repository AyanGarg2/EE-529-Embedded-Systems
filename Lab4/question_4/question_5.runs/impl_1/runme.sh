...
HD_PWD='C:/Users/ayang/Desktop/Sem 6/Embedded Systems/Labs/Lab4/question_5/question_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log switch_to_7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source switch_to_7seg.tcl -notrace
