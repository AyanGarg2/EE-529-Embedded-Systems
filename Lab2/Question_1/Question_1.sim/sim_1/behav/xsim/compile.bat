...
REM
REM Generated by Vivado on Mon Feb 09 19:40:43 +0530 2026
...
echo "xvhdl --incr --relax -prj q1_structural_tb_vhdl.prj"
call xvhdl  --incr --relax -prj q1_structural_tb_vhdl.prj -log xvhdl.log
