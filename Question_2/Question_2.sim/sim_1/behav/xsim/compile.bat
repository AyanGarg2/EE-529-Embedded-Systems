...
REM
REM Generated by Vivado on Mon Jan 26 19:24:59 +0530 2026
...
echo "xvhdl --incr --relax -prj top_2b_tb_vhdl.prj"
call xvhdl  --incr --relax -prj top_2b_tb_vhdl.prj -log xvhdl.log
