...
REM
REM Generated by Vivado on Tue Feb 17 00:05:46 +0530 2026
...
echo "xvhdl --incr --relax -prj tb_SRAM_6116_vhdl.prj"
call xvhdl  --incr --relax -prj tb_SRAM_6116_vhdl.prj -log xvhdl.log
