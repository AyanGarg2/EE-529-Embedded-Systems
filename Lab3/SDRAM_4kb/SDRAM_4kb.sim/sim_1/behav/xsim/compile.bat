...
REM
REM Generated by Vivado on Mon Feb 16 23:35:44 +0530 2026
...
echo "xvhdl --incr --relax -prj SDRAM_4KB_tb_vhdl.prj"
call xvhdl  --incr --relax -prj SDRAM_4KB_tb_vhdl.prj -log xvhdl.log
