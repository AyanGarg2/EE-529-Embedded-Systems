...
REM
REM Generated by Vivado on Tue Feb 17 11:43:31 +0530 2026
...
echo "xvhdl --incr --relax -prj MeanCalculator_tb_vhdl.prj"
call xvhdl  --incr --relax -prj MeanCalculator_tb_vhdl.prj -log xvhdl.log
