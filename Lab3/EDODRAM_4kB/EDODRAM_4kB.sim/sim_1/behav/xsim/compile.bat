...
REM
REM Generated by Vivado on Mon Feb 16 22:52:53 +0530 2026
...
echo "xvhdl --incr --relax -prj EDO_DRAM_tb_vhdl.prj"
call xvhdl  --incr --relax -prj EDO_DRAM_tb_vhdl.prj -log xvhdl.log
